...
async function loadBlockchainData() {
  ...
  document.querySelector(".contract-address").innerHTML =
    '<a href="https://goerli.etherscan.io/address/' + contractAddress + '">' + contractAddressShortened + '</a> Code on Github: <a href="https://github.com/rene78/Heads-Or-Tails">Heads or Tails</a>';
  ...
  if (activeNetwork.chainId === deployedNetwork) {
    ...
    if (provider.connection) signer = provider.getSigner();
...
function scrollDown() {
  ...
  setTimeout(function () {
    coinAnimation.scrollIntoView();
  }, 10); //Without delay scrollIntoView does not work.
}
